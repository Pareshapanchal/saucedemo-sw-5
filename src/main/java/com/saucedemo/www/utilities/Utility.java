...
public class Utility extends ManageBrowser {
    ...
    /*
    This methos will send text to element
     */
    public void sendTextToElement(WebElement element,String str){ element.sendKeys(str);    }
    /*
    ...
    /*
    This method will send text form alert
     */
    public void sendTextToAlert(String text){driver.switchTo().alert().sendKeys(text);}
//**********************************************Select Class Method ****************************
    /**
...
//***************************** Is Display Methods **********************************************//
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/www/saucedemo/screenshots/" + screenshotName + dateName + ".png";
    ...
    public int getTheNumberOfElementOnTheList(List<WebElement> elements){
